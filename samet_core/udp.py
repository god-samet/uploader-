from samet_core import database, ip
from threading import Thread
from random import uniform, randint
from time import sleep
from random import choices
import socket
from samet_core.log import store_new_upload_agent_log, store_new_udp_uploader_log
from samet_core.time import get_now_time
...
def set_upload_size_and_uploader_count(total_upload_size, total_uploader_count):
    ...
    upload_size_max_range = choices([80, 150, 250], [1, 2, 3], k=1)[0]
    total_upload_size_for_each_ip = int(uniform((upload_size_max_range - 80) * coefficient_of_upload,
