...
from samet_core import database, network
from samet_menu import display
...
def system_usage():
    ...
    samet_monitor = PrettyTable()
    samet_monitor.field_names = [f"{display.cyan_color}Σ Upload{display.cornsilk_color}",
