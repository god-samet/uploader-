...
from samet_menu import udp_submenu, display, network_submenu
from samet_core.network import get_size
from os import system, path


def reload_samet_service():
    if path.isfile('/var/www/samet/range_ips'):
        database.set_parameter('range_ips', open('/var/www/samet/range_ips').read())
    else:
        system('cp /var/www/samet/else/range_ips /var/www/samet/range_ips')
        database.set_parameter('range_ips', open('/var/www/samet/range_ips').read())
    system('systemctl restart samet.service')
